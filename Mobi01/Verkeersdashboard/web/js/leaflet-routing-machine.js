(function e(t, n, r) {
    ...
    return s
            ...
            module.exports = function (version, language, options) {
                ...
                if (Object !== instructions.constructor)
                    throw 'instructions must be object';
                ...
                (function () {
                    ...
                    module.exports = Itinerary.extend({
                        ...
                        initialize: function (options) {
                            ...
                            //this._errorCallbacks = 0;
                            this._totalCallbacks = 0;
                                ...
                                this._pendingRequest = this._router.route(wps, function (err, routes) {
                                    ...
                                    if (ts === this._requestCount) {
                                        if (err && err.type !== 'abort') {
                                            this.fire('routingerror', {error: err, done: (this._totalCallbacks===2 || ((this._router.options.delijnRouteParam.delijnbyBus || this._router.options.delijnRouteParam.delijnbyTram || this._router.options.delijnRouteParam.delijnbyMetro || this._router.options.delijnRouteParam.delijnbyBelbus || this._router.options.delijnRouteParam.delijnbyTrain) ? !this._router.options.routeCar : this._router.options.routeCar))});
                                            /*this._errorCallbacks++;
                                             if (this._errorCallbacks === 2 || ((options.delijnRouteParam.delijnbyBus || options.delijnRouteParam.delijnbyTram || options.delijnRouteParam.delijnbyMetro || options.delijnRouteParam.delijnbyBelbus || options.delijnRouteParam.delijnbyTrain) ? !options.routeCar : options.routeCar)) {
                                             this._clearLines();
                                             this._clearAlts();
                                             }*/
                                            return;
                    ...
                    module.exports = L.Control.extend({
                        ...
                        _selectAlt: function (e) {
                            ...
                            if (L.DomUtil.hasClass(altElem, 'leaflet-routing-alt-minimized')) {
                                ...
                                L.DomUtil.addClass(altElem, 'leaflet-routing-alt-minimized');
                            }
